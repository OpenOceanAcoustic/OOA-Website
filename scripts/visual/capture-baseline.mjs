...
const baseUrl = process.env.OOA_VISUAL_BASE_URL ?? "http://127.0.0.1:4174";
const outputDirectory = resolve("tests/visual/baseline");
const routes = [
...
console.log(`Visual baseline captured in ${outputDirectory}`);
